...
import qrcode.birdex.com.birdexqr.update.UpdateManager;
...
//         如果是第一次打开，检查更新
        if (MyApplication.getInstans().isFirst()) {
            QrCodeAPI.upDateMessage(MyApplication.getInstans(), null, new JsonHttpResponseHandler() {
                @Override
...
//					super.onSuccess(statusCode, headers, response);
                    try {
                        ...
                        if(!versionLocal.equals(versionServer)) {
                            ...
                            // 如果不相等，执行更新操作
                            UpdateManager.getInstance().set(MipcaActivityCapture.this);
                        }
...
//					super.onFailure(statusCode, headers, responseString, throwable);
            ...
            MyApplication.getInstans().setIsFirst(false);
        }
